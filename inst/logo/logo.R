...
royalty_free_image <- image_read(system.file("logo", "logo.png",
                                             package = "shinyreturns"
))

# set the package name
package_name <- "shinyreturns"

# set the package url
url_package <- "https://github.com/Layalchristine24/shinyreturns"
...
sticker(
  ...
  s_y = 1.0, #                   * subplot y-position (up/down position)
  ...
  h_fill = "#E9E2FF", #          * hexSticker background color
